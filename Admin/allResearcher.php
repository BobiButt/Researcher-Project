...
$sql = "SELECT id, username FROM users WHERE role = 'researcher' && ban_until IS NULL";
...
if (isset($_POST['ban_id'])) {
    $ban = $_POST['ban_id'];
   $sql = " UPDATE users SET ban_until = DATE_ADD(NOW(), INTERVAL 7 DAY) WHERE id = '$ban'";
 }
